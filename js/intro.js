...
function onClickStartIntro(){
    ...
    $('#scene_target').html('<p id="intro_text1">Une catastrophe que nul n\'aurait pu prévoir survint au moment où la paix et l\'harmonie commençaient enfin à régner sur terre.</p><p id="intro_text2">La troisième guerre mondiale avait pu être évitée et les gouvernements des blocs est-ouest s\'efforçaient désormais d\'instaurer une paix durable dans le monde.</p><p id="intro_text3">Dans le domaine agricole, des techniques de production révolutionnaires avaient aboli la famine dans les régions les plus défavorisées du globe.</p><p id="intro_text4">Les progrès remarquables réalisés dans le secteur de la communication et des moyens de transport avaient contribué à une meilleure compréhension entre les peuples.</p>');
...
function introPart3(){
    ...
    $('#scene_target').html('<p id="intro_text1">Et pourtant, il ne restait plus que quelques heures avant la fin de la civilisation.</p><p id="intro_text2">Un peu plus tard dans la même journée, une maladie inconnue se déclara à New York et se propagea à une telle rapidité que la moitié de la population de la ville fut décimée, avant même que les autorités scientifiques et gouvernementales aient pu comprendre de quoi il s\'agissait.</p><p id="intro_text3">La maladie s\'étendit à la terre entière, transmise par le trafic de population.</p><p id="intro_text4">L\'épidemie fit de véritables ravages dans les zones à forte densité de population et toutes les tentatives de quarantaine s\'avérèrent vite inutiles devant l\'ampleur du phénomème.</p>');
...
function introPart4(){
    ...
    $('#scene_target').html('<p id="intro_text1">Quatre jours plus tard.</p><p id="intro_text2">85% de la population mondiale avait disparu.</p><p id="intro_text3">Les communications, les principaux services publics, les transports, les administrations, et même les gouvernements avaient cessé de fonctionner.</p><p id="intro_text4">Parmi les rescapés, personne ne pouvait désormais expliquer les causes de cette maladie inconnue. Quoiqu’il en soit, leur seule et unique préoccupation était désormais de survivre.</p>');
...
function introPart5(){
    ...
    $('#scene_target').html('<p id="intro_text1">Quelques semaines plus tard.</p><p id="intro_text2">La civilisation commença à se dégrader à une rapidité affolante. La plupart des survivants ne comprenaient pas pourquoi ils se trouvaient toujours en vie et ils se demandaient par quels moyens ils pourraient le rester.</p><p id="intro_text3">Ce fut bientôt l’avènement de la loi du plus fort : les émeutes, le pillage, le vandalisme et l’ébriété étaient phénomènes courants.</p><p id="intro_text4">Certains individus étaient même prêts à tuer pour une boîte de conserve et les grandes villes furent bientôt désertées, en raison du manque de vivres et des risques de contamination.</p>');
...
function introPart6(){
    ...
    $('#scene_target').html('<p id="intro_text1">Six mois après la catastrophe.</p><p id="intro_text2">On pouvait diviser les survivants en deux catégories : d’une part, ceux qui désiraient rétablir l’ordre et la sécurité, d’autre part, ceux qui s’accommodaient du chaos et découvraient dans la violence et l’anarchie un nouvel art de vivre.</p><p id="intro_text3">Les premiers se regroupèrent pour vivre dans de petites villes qu’ils transformèrent en places fortes. A l’intérieur de celles-ci, les habitants élurent des dirigeants et s’efforcèrent de vivre en autarcie.</p><p id="intro_text4">La seconde catégorie de survivants se groupèrent en petites bandes pour mener une existence semi-nomade où régnaient la violence et la brutalité. Ces « nouveaux barbares » sillonnaient le pays, semant partout la terreur et anéantissant les communautés civilisées qui avaient le malheur de se trouver sur leur chemin.</p>');
...
function introPart7(){
    ...
    $('#scene_target').html('<p id="intro_text1">Vous êtes l’un des survivants habitant la ville fortifiée de Nouvelle Espérance.</p><p id="intro_text2">Un soir, vous entendez frapper à votre porte. Vos visiteurs sont deux membres du Conseil Municipal.</p><p id="intro_text3">Ils vous révèlent qu’ils viennent de capter un message-radio provenant de San Angelo, une raffinerie de pétrole fortifiée située au sud du pays.</p><p id="intro_text4">Les habitants de San Angelo proposent d’échanger dix mille litres d’essence contre des céréales et du grain, indispensables à l’amélioration de leur production alimentaire. C’est une occasion unique à ne pas laisser passer.</p>');
...
function introPart8(){
    ...
    $('#scene_target').html('<p id="intro_text1">Le Conseil a accepté ce marché et vous demande d’entreprendre ce voyage.</p><p id="intro_text2">Vous y ramenerez ensuite un camion-citerne rempli d’essence, et selon eux, vous êtes la personne la mieux qualifiée pour remplir cette mission.</p><p id="intro_text3">Il s’agit là d’une expédition fort dangereuse, à travers un monde sauvage et hostile. Vous apprenez qu’une Dodge Interceptor sera spécialement équipée pour le voyage.</p><p id="intro_text4">Le profit énorme que votre ville pourra tirer de cette opération suffit à vous convaincre d’accepter la mission. Vous demandez de commencer dès à présent les préparatifs de l’expédition.</p>');
...
function introPart9(){
   ...
   //fadeIn texts
    $('#intro_text1').hide().fadeIn(2000);
    $('#intro_text2').hide().delay(4000).fadeIn(3000);
    $('#intro_text3').hide().delay(8000).fadeIn(3000);
    $('#intro_text4').hide().delay(12000).fadeIn(3000, function(){
