...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 29 nov. 2018 à 17:27
...
(219, 'De votre ton le plus convaincant, vous lui assurez que vous n\'êtes pour rien dans la mort de sa femme et de son fils.', 'Chanceux ?', 288, 'Malchanceux ?', 236, NULL),
...
(374, 'Vous tirez votre couteau, prêt à attaquer, lorsque le chien se jette sur vous.', 'Vous réussissez à tuer le chien.', 89, 'Le chien vous dévore.', 666, NULL),
...
(176, 'Combat revolver', 'Vous êtes dans un mauvais jour.', 350, 'Vous êtes dans un bon jour.', 108, NULL),
(108, 'A votre grand soulagement, vous ne manquez pas votre cible et le chien est tué sur le coup.', '...', 89, '', NULL, NULL),
(350, 'Vous manquez votre tir et le chien continue à se rapprocher. Soudain, il se jette sur vous, et vous devez saisir votre poignard pour vous défendre.', 'Vous sortez vainqueur.', 89, 'Vous perdez.', 666, NULL),
(333, 'Combat revolver', 'Vous êtes dans un bon jour.', 57, 'Vous êtes dans un mauvais jour.', 86, NULL),
(666, '', '', NULL, '', NULL, NULL);
